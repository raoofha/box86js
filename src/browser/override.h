...
typedef ssize_t cookie_read_function_t (void *__cookie, char *__buf, size_t __nbytes);
typedef ssize_t cookie_write_function_t (void *__cookie, const char *__buf, size_t __nbytes);
typedef int cookie_seek_function_t (void *__cookie, off64_t *__pos, int __w);
